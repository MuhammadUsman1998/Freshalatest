    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className="w-full mt-8 sm:mx-auto sm:w-full sm:max-w-md flex justify-center">
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 2xl:w-2/5 lg:w-2/4 md:w-2/3">
                    ...
                    <div className="mt-6">
                        ...
                        <Link to="/signUpForm" className=" cursor-pointer flex justify-center text-blue-400">Sign up now</Link>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md flex justify-center">
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 2xl:w-2/5 lg:2/4 md:w-2/3 sm:w-2/3 ">
